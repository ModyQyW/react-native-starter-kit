...
@observer
class DemoLayout1 extends React.Component {
  handleBack = () => {
  ...
  render () {
    return (
      <View style={layouts.container}>
        ...
        >
          <Text>Body</Text>
          <Text style={typography.textMainLight}>
            To test scroll, insert lorem below.
          </Text>
          <Text>
...
DemoLayout1.propTypes = {
  navigation: PropTypes.any
}

export default DemoLayout1
